...
@DisplayName("Convert address from BCH to eCash format")
public class BitcoinCashToECashAddress_Test {

    @Test
    @DisplayName("Version - P2PKH")
    void testBitcoinCashToECashP2PKH() {
        ...
        assertEquals(ecash_address, AddressConverter.BitcoinCashToECashAddress(bch_address));
    }

    @Test
    @DisplayName("Version - P2SH")
    void testBitcoinCashToECashP2SH() {
