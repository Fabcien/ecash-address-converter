...
@DisplayName("Convert address from eCash to BCH format")
public class ECashToBitcoinCashAddress_Test {

    @Test
    @DisplayName("Version - P2PKH")
    void testECashToBitcoinCashP2PKH() {
        ...
        assertEquals(bch_address, AddressConverter.eCashToBitcoinCashAddress(ecash_address));
    }

    @Test
    @DisplayName("Version - P2SH")
    void testECashToBitcoinCashP2SH() {
